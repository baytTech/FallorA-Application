...
class _HoroscopeSectionWidgetState extends State<HoroscopeSectionWidget> {
  ...
  void initState() {
    super.initState();
    viewModel = createModel(context, () => HoroscopeSectionModel(
      functionsRepo: getIt(),
      authManager: getIt()
    ));
  ...
  Future<HoroscopeSelectableItem?> selectHoroscopeBottomSheet() {
    return horoscopeSelectionBottomSheetBuilder(
      context: context, 
      controller: viewModel.horoscopesController
    ).then((value) => viewModel.commentCubit.setState(value));
  }

  Future<DartRecord<GenderSelectableItem,HoroscopeSelectableItem>?> selectHoroscopeAndGenderBottomSheet() {
                      ...
                      builder: (context,state) {
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.symmetric(vertical: 20,horizontal: 12),
                                child: Row(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          image: DecorationImage(
                                            ...
                                            image: AssetImage(state!=null ? state.horoscope.imagePath:"")
                                          ),
                                          boxShadow: [
                                            BoxShadow(
                                              blurRadius: 5.0,
                                        ...
                                        child: Align(
                                          ...
                                          child: Text(state!=null ? state.horoscope.description : "",
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          context.pushNamed('HoroscopeCommentary');
                                        },
                                        text: 'Devamını oku ',
                                        options: FFButtonOptions(
                                          ...
                                          textStyle: FlutterFlowTheme.of(context).titleSmall.copyWith(color: AppColors.white),
                                          elevation: 2.0,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            mainAxisAlignment:MainAxisAlignment.spaceEvenly,
                                            children: [
                                              Image.asset('assets/images/horoscope/gemini_sign.png',
                                                width: 100.0,
                                              ...
                                              Text(
                                                'Başak Kadını',
                                                style: FlutterFlowTheme.of(context).bodyMedium.copyWith(color: AppColors.white),
                                              ),
                                            ],
                                            ),
                                          ),
