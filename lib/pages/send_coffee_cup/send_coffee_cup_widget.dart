                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    setState(() => viewModel.isDataUploading1 = true);
                                    ...
                                    try {
                                      selectedUploadedFiles = selectedMedia
                                          ...
                                          .toList();
                                    } finally {viewModel.isDataUploading1 = false;}
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (selectedMedia != null &&
                                      selectedMedia.every((m) =>validateFileFormat(m.storagePath, context))) {
                                    setState(() => viewModel.isDataUploading2 = true);
                                    var selectedUploadedFiles = <FFUploadedFile>[];
                                    try {
                                      selectedUploadedFiles = selectedMedia
                                          .map((m) => FFUploadedFile(
                                    ...
                                    if (selectedUploadedFiles.length == selectedMedia.length) {
                                      setState(() {viewModel.uploadedLocalFile2 =selectedUploadedFiles.first;});
                                    } else {
                                      setState(() {});
                                      return;
                                    }
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (selectedMedia != null &&
                                      selectedMedia.every((m) =>validateFileFormat(m.storagePath, context))) {
                                    setState(() => viewModel.isDataUploading3 = true);
                                    var selectedUploadedFiles = <FFUploadedFile>[];
                                    try {
                                      selectedUploadedFiles = selectedMedia
                                          .map((m) => FFUploadedFile(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FalloraDropDownWidget<String>(
                                ...
                                onChanged: (val) => setState(() => viewModel.dropDownValue1 = val),
                                width: double.infinity,
                                textStyle: textStyle,
                            ...
                            Padding(
                              ...
                              child: FalloraDropDownWidget<String>(
                                ...
                                onChanged: (val) => setState(() => viewModel.dropDownValue2 = val),
                                height: 60,
                                textStyle: textStyle,
                                hintText: 'Kategori',
                                margin: EdgeInsetsDirectional.fromSTEB(12.0, 4.0, 12.0, 4.0),
