...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, String idToken});
}
...
class _$_LoginResponse implements _LoginResponse {
  const _$_LoginResponse({required this.message, required this.idToken});
  ...
  @override
  String toString() {
    return 'LoginResponse(message: $message, idToken: $idToken)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, message, idToken);
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final String idToken}) = _$_LoginResponse;
